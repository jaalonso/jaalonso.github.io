...
-- En este ejercicio se va a implementar el juego de la adivinación de
-- un número en Haskell. Presentaremos dos versiones dependiendo de si 
-- el número lo tiene que adivinar la máquina o el jugador humano.

-- ---------------------------------------------------------------------
-- Ejercicio 1. En el primer juego la máquina le pide al jugador humano
-- que piense un número entre 1 y 100 y trata de adivinar el número que
-- ha pensado planteándole conjeturas a las que el jugador humano
-- responde con mayor, menor o exacto según que el número pensado sea
-- mayor, menor o igual que el número conjeturado por la
-- máquina. Definir la función 
--    juego1 :: IO ()
...
-- 
-- Nota: Implementar la estrategia de la máquina de forma que se
-- minimice el número de intentos de adivinación.
-- ---------------------------------------------------------------------
...
adivina a b =
    do putStr ("Es " ++ show conjetura ++ "? [mayor/menor/exacto] ")
       ...
       case s of
         ...
         "exacto" -> return ()
         _        -> adivina a b
    where conjetura = (a+b) `div` 2

-- ---------------------------------------------------------------------
-- Ejercicio 2. En el segundo juego la máquina genera un número
...
-- responde con mayor, menor o exacto según que el número pensado sea
-- mayor, menor o igual que el número conjeturado por el jugador
-- humano. Definir la función 
--    juego2 :: IO ()
