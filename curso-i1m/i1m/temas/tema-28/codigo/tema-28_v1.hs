-- tema-20.hs: Análisis de complejidad de algoritmos
...
-- La comprobación es
--    *Main> [(n,t_sumaSuma n) | n <- [100,200..600]]
...
-- El cálculo es
--    *Main> nEsimaAproximacion  9 1 5
--    3.0
--    *Main> nEsimaAproximacion  16 1 5
--    4.0000005
--    *Main> nEsimaAproximacion  16 1 10
--    4.0
...
-- La comprobación es
--    *Main> quickCheck prop_nEsimaAproximacion
--    OK, passed 100 tests.
